        ...
        <el-aside  class="widget-config-container">
          <el-container>
            <el-header height="45px">
              <div class="config-tab" :class="{active: componentTab=='component'}" @click="handleComponentSelect('component')">{{$t('fm.components.basic.title1')}}</div>
              <div class="config-tab" :class="{active: componentTab=='dic'}" @click="handleComponentSelect('dic')">{{$t('fm.components.basic.title2')}}</div>
            </el-header>
            <el-main class="config-content">
              <div class="components-list" v-show="componentTab=='component'">
